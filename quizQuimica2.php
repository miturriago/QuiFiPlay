...
<head>
  ...
  <script src="quimica/quizzer2.js"></script>
</head>
<body>
  <header>
  ...
  <div class="start">
    <div class="card">
      <iframe width="450" height="350" src="https://www.youtube.com/embed/24jEILbTtyA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
  ...
  <div class="finish card">
    ...
    <div class="play_again">
      ...
      <br>
      <a href="quizQuimica3.php"><img src="images/avanzar.png" height="50" width="100" alt="Botón"></a>
