...
<head>
  ...
  <script src="quimica/quizzer5.js"></script>
</head>
<body>
  <header>
  ...
  <div class="start">
    <div class="card">
      <iframe width="450" height="350" src="https://www.youtube.com/embed/z0AGY0OKu1Y" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
  ...
  <div class="finish card">
    ...
    <div class="play_again">
      ...
      <br>
      <a href="images/Diploma.png" download="Química">
        Descargar Diploma
        </a>
