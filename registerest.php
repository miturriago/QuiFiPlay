...
if (!empty($_POST['email'])&&!empty($_POST['pass'])&&!empty($_POST['pass2'])&&!empty($_POST['nombre'])&&!empty($_POST['idescuela'])) {
	$contr=$_POST['pass'];
	$contr2=$_POST['pass2'];
	if($contr==$contr2){
		$sql="INSERT INTO estudiante (idescuela, nombre, email, pass) VALUES(:idescuela,:nombre,:email,:pass)";
...
<body>
	...
	<div class="wrap">
		...
		<form action="registerest.php" method="POST">
			...
			<p> ¿Ya tiene una cuenta? <a href="sigin.php"> Click aquí </a></p>
