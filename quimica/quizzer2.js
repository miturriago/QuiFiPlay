...
var questions = [
    [
      "1.	La teoría atómica moderna explica las leyes de",
      "Ley de la conservación de la masa, composición constante y proporciones múltiples.  ",
      "Ley de proporciones múltiples, la temperatura y composición constante.",
      "Ley de las cargas, la temperatura y conservación de la masa.",
      "Ninguna de las anteriores",
      0
    ],
    [
      "2.	¿Cuantos postulados propuso Dalton?",
      "Dos postulados",
      "Un solo postulado",
      "Tres postulados",
      "Cuatro postulados",
    ...
    [
        "3.	Los átomos se unen en una relación sencilla para formar:",
       "Sustancias",
       "Compuestos",
       "Elementos",
       "átomos",
