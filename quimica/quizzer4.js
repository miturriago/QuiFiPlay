var questions = [
    [
      "1.  Bohr propone que:",
      "Que los átomos tiene cargas neutras.",
      "Que los átomos se desplazan alrededor del núcleo.",
      "Que ni existe carga positiva en un  electrón.",
      "Ninguna de las anteriores",
      1
    ],
    [
      "2. ¿Cuántos postulados tiene el modelo atómico de Bohr?",
      "No tiene",
      "Cuatro",
      "Dos",
      "Tres",
    ...
    [
        "3. ¿los átomos se mueven alrededor del núcleo?",
       "No",
       "Si",
       "Tal vez",
     ...
     [
        "4. cuándo los átomos se mueven en el núcleo ¿Qué pasa?",
       "Gana y pierden electrones",
       "Su carga es la misma",
       "Su carga siempre quedan positivas",
       "Su carga queda negativa",
        0
      ],
      [
        "5. ¿los átomos que se mueven alrededor del núcleo forman ondas?",
       "No",
       "Si",
       "No es posible",
       "Tal vez",
